classdef cscan < UTLib.utmeasurement
    ...
    methods
        ...
        function plot(this, varargin)
            ...
            surf(this.X, this.Y, C)
            view(2)
            shading interp
            axis equal
            axis tight
            set(gca, 'FontWeight', 'normal', 'FontSize', 36, ...
                   'XTick', 0:options.Ticks(1):max(this.X(:)), ...
                   'YTick', 0:options.Ticks(2):max(this.Y(:)));
            xlabel('X (mm)')
            ylabel('Y (mm)')
